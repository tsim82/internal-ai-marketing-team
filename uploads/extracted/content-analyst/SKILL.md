...
description: Analyze your short-form content performance - hook effectiveness, visual formats, engagement patterns, and weekly reports. Use when reviewing what's working in your content. For a deep dive, use /shortform-analysis.
---
...
### Comparison 1: [Describe what connects these]
...
**CRITICAL:** Only compare videos that are actually similar. If you can't find a near-match for a winner, skip it and find another winner that does have comparable videos.
...
**Skills:**
- `/content-analyst` (this skill) - Quick weekly performance check
- `/shortform-analysis` - Deep 12-section analysis with per-platform dives and scripter brief
