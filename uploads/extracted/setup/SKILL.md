...
- `~/.noeai/templates/` - template files
- `~/.noeai/prompts/` - prompt packs
- `~/.noeai/mcp-configs/` - MCP server configs
...
1. **Airtable** - copy `~/.noeai/mcp-configs/airtable.json` → `~/.claude/settings.json`
2. **Meta Ads** - copy `~/.noeai/mcp-configs/meta-ads.json` → `~/.claude/settings.json`
3. **Slack** - copy `~/.noeai/mcp-configs/slack.json` → `~/.claude/settings.json`
4. **Notion** - copy `~/.noeai/mcp-configs/notion.json` → `~/.claude/settings.json`
5. **Google Drive** - copy `~/.noeai/mcp-configs/google-drive.json` → `~/.claude/settings.json`
6. **Filesystem** - copy `~/.noeai/mcp-configs/filesystem.json` → `~/.claude/settings.json`
